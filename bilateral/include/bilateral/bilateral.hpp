...
namespace MotorInv
{
static constexpr std::array<double, 3> a0 = {140.7, 34.4, 2.083};
static constexpr std::array<double, 3> a1 = {-281.4, -68.81, -4.166};
static constexpr std::array<double, 3> a2 = {140.7, 34.4, 2.083};
